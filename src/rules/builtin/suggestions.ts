...
export default mapOptionsAsErrors({
  ...
  "dot-notation": [{ allowKeywords: true }],
  eqeqeq: ["always", { null: "always" }],
  "func-name-matching": ["always"],
  "func-names": ["as-needed", { generators: "as-needed" }],
  "func-style": ["expression"],
  "grouped-accessor-pairs": ["getBeforeSet"],
  "guard-for-in": true,
  "id-denylist": false,
  "id-length": false,
  // NOTE: This could be improved to allow specific casings
  // But I'm not in the mood to write complex regex now
  "id-match": false,
  "init-declarations": ["always"],
  // NOTE: Is there something we can improve here?
  "max-classes-per-file": false,
  "max-depth": { max: 4 },
  // NOTE: Generally spec files are very big. Can we improve this?
  "max-lines": { max: 300, skipBlankLines: true, skipComments: true },
  ...
  "max-nested-callbacks": { max: 4 },
  "max-params": { max: 4 },
  // NOTE: This needs to be tested against real production code
  // To feel if it is good number
  "max-statements": { max: 20 },
  "multiline-comment-style": false,
  // NOTE: This needs to be tested against real production code
  "new-cap": { newIsCap: true, capIsNew: true, properties: true },
